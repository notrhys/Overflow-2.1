...
public final class SpeedC extends PositionCheck {
    ...
    public void process(final PositionUpdate positionUpdate) {
        ...
        if (positionManager.getTouchingClimbable().get() || positionManager.getTouchingIllegalBlocks().get() || positionManager.getTouchingHalfBlocks().get() || positionManager.getBelowBlocks().get()) {
            return;
        }
