...
public final class PositionManager {
    ...
    public void updatePositionFlags(final Location to) {
        ...
        OverflowAPI.INSTANCE.getPositionExecutor().execute(() -> {
            ...
            final boolean touchingIllegalBlocks = cuboid.checkBlocks(to.getWorld(), material -> material.getData() == DaylightDetector.class || material.getData() == Skull.class || material.getData() == FlowerPot.class || material == Material.CARPET || material == Material.CAULDRON || material == Material.WATER_LILY || material == Material.WEB || material.name().equals("SLIME_BLOCK"));
