...
public final class PacketHandler1_12_R1 extends PlayerConnection {
    private final PlayerData playerData;

    public PacketHandler1_12_R1(final MinecraftServer minecraftserver, final NetworkManager networkmanager, final EntityPlayer entityplayer, final PlayerData playerData) {
    ...
    public void a(final PacketPlayInUseEntity packet) {
        ...
        switch (packet.a()) {
            case ATTACK: {
                ...
                final Entity entity = Objects.requireNonNull(packet.a(player.world)).getBukkitEntity();
