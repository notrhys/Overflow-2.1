...
public final class PacketHandler1_8_R3 extends PlayerConnection {
    ...
    public PacketHandler1_8_R3(final MinecraftServer minecraftserver, final NetworkManager networkmanager, final EntityPlayer entityplayer, final PlayerData playerData) {
    ...
    public void a(final PacketPlayInFlying packet) {
        ...
        final boolean checkMovement = ReflectionUtil.getFieldValue(PacketPlayInFlying.class, "hasPos", boolean.class, packet);
